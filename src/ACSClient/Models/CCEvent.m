...
-(id)initWithJsonResponse:(NSDictionary *)jsonResponse
{
	...
	if (self) {
		@try {
            ...
            if (dateString) {
                self.startTime = [[[ACSClient defaultACSClient] jsonDateFormatter] dateFromString:dateString];
            }
        ...
        if (dateString) {
            self.recurringUntil = [[[ACSClient defaultACSClient] jsonDateFormatter] dateFromString:dateString];
        }
...
-(id)initWithJsonResponse:(NSDictionary *)jsonResponse
{
	...
	if (self) {
		...
		@try {
            ...
            if (dateString) {
                self.endTime = [[[ACSClient defaultACSClient] jsonDateFormatter] dateFromString:dateString];
            }
