...
-(void)addOauthHeaderToRequest
{
	if (![[ACSClient defaultACSClient] getOauthConsumerKey] || ![[ACSClient defaultACSClient] getOauthConsumerSecret]) {
		// nothing to add
		return;
	}
	BOOL postRequest = NO;
	...
	NSString *header = OAuthorizationHeader([self url],
											[self requestMethod],
											body,
											[[ACSClient defaultACSClient] getOauthConsumerKey],
											[[ACSClient defaultACSClient] getOauthConsumerSecret],
											@"",
											@"");
...
{
	NSString *url = nil;
	NSString *appKey = [[ACSClient defaultACSClient] getAppKey];
    NSString *paramsString = nil;
    NSString *backendUrl = [[ACSClient defaultACSClient] apiURL];
