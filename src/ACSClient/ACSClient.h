...
@interface ACSClient : NSObject<FBSessionDelegate, FBRequestDelegate> {
...
@property(nonatomic, retain, readonly) NSString *acsDir;
...
// Your program should implement the delegate methods if you use ACS
